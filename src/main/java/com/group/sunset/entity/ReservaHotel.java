...
public class ReservaHotel implements  Cloneable, Externalizable {
	...
	public void setUcheckin(String ucheckin) {
		this.ucheckin = ucheckin;
	}

	public String getUcheckin() {
		return ucheckin;
	}

	public void setUcheckout(String ucheckout) {
		this.ucheckout = ucheckout;
	}

	public String getUcheckout() {
		return ucheckout;
	}
	...
	public void setVecpulseras(Vector<Pulseras> xvector) {
		vecpulseras = xvector;
	}

	public Vector<Pulseras> getVecpulseras() {
		return vecpulseras;
	}

	public void setVecaco(Vector<Acompaniantes> xvector) {
		vecaco = xvector;
	}

	public Vector<Acompaniantes> getVecaco() {
		return vecaco;
	}

	public void setVecSerCon(Vector xvector) {
		vecsercon = xvector;
	}

	public Vector getVecSerCon() {
		return vecsercon;
	}


        public void setVecDepositos(Vector xvector) {
                vecdepositos = xvector;
        }

        public Vector getVecDepositos() {
                return vecdepositos;
	}
        ...
        public List<ServiciosEspeciales> getServiciosespeciales() {
            return serviciosespeciales;
        }

        public void setServiciosespeciales(List<ServiciosEspeciales> serviciosespeciales) {
            this.serviciosespeciales = serviciosespeciales;
        }
        

	public void setVecCargos(Vector xvector) {
		veccar = xvector;
	}

	public Vector getVecCargos() {
		return veccar;
	}
	...
	public Vector<Pulseras> vecpulseras;
	public Vector<Acompaniantes> vecaco;
	public Vector<CargosExtras> veccar;
	public Vector<ServiciosContratados> vecsercon;
        public Vector vecdepositos;
        public List<Depositos>  depositos;
        public List<ServiciosEspeciales> serviciosespeciales;
	...
	private String ucheckin;
	private String ucheckout;
	private int uclub;
	...
	public void readExternal(ObjectInput in)
		...
		vecpulseras = (Vector) in.readObject();
		vecaco = (Vector) in.readObject();
		veccar = (Vector) in.readObject();
		vecsercon = (Vector) in.readObject();
                vecdepositos = (Vector) in.readObject();
                depositos    = ( List )  in.readObject();
                serviciosespeciales    = ( List )  in.readObject();
		...
		fechareserva = (String) in.readObject();
		fechacancela = (String) in.readObject();
		fechaentrada = (String) in.readObject();
		fechasalida = (String) in.readObject();
		...
		ucheckin = (String) in.readObject();
		ucheckout = (String) in.readObject();
		...
		tarifanumber = in.readDouble();
                ...
                origen       = (String) in.readObject();
                
                folmembresia       = (String) in.readObject();
                
                split =(Boolean)  in.readObject();
...
//	}
	...
	public void writeExternal(ObjectOutput out) throws IOException {
		...
		out.writeObject(fechareserva);
		out.writeObject(fechacancela);
		out.writeObject(fechaentrada);
		out.writeObject(fechasalida);
		...
		out.writeObject(ucheckin);
		out.writeObject(ucheckout);
